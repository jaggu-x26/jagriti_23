 ...
 * @author Admin
 */
public class vegge extends javax.swing.JFrame {

    /**
     * Creates new form vegge
     * 
     */
    int a=499;
    int b=599;
    ...
    private void initComponents() {
        ...
        l2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/cart.png")));
        ...
        l3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/vegge1.jpg"))); // NOI18N
        ...
        l5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/vegge3.jpg"))); // NOI18N
        ...
        l4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/vegge2.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       name="V.Cheese Burst";
        ...
        try{
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/student","root","");
                Statement stmt=con.createStatement();
                String sql1="select * from pizzadetail where Username='"+p+"'";
                ResultSet rs=stmt.executeQuery(sql1);
                while(rs.next())
                {
                    a1=rs.getInt("id");
                }
                String sql="insert into pizzadetail(id,Username,Pname,Size,Quantity,Prize,img)"+"values('"+(a1+1)+"','"+p+"','"+name+"','"+na+"','"+q+"','"+d+"','vegge1.jpg')";
                stmt.executeUpdate(sql);
            }
            catch(Exception e1){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       num=8;
        ...
        try{
                ...
                String sql="insert into pizzadetail(id,Username,Pname,Size,Quantity,Prize,img)"+"values('"+(a1+1)+"','"+p+"','"+name+"','"+na+"','"+q+"','"+d+"','vegge3.jpg')";
                stmt.executeUpdate(sql);
            }
            catch(Exception e1){
                JOptionPane.showMessageDialog(null, e1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
                ...
                String sql="insert into pizzadetail(id,Username,Pname,Size,Quantity,Prize,img)"+"values('"+(a1+1)+"','"+p+"','"+name+"','"+na+"','"+q+"','"+d+"','vegge2.jpg')";
                stmt.executeUpdate(sql);
            }
            catch(Exception e1){
                JOptionPane.showMessageDialog(null, e1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vegge.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
