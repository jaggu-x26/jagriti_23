...
import static cac2_project.summer.name;
...
public class chicken extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        l3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/loaded.jpg"))); // NOI18N
        ...
        l4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/periperi.jpg"))); // NOI18N
        ...
        l5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cac2_project/barbeque.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(625, 407));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
             ...
             if(rs.next() == false)
               {
                ...
                rs.close();
               sql="update pizzadetail set Pname='"+name1+"',Size='"+na+"',Quantity='"+q+"',Prize='"+d+"' where Username='"+f+"'";
        ...
        try{
                ...
                String sql="insert into pizzadetail(id,Username,Pname,Size,Quantity,Prize,img)"+"values('"+(a1+1)+"','"+f+"','"+name1+"','"+na+"','"+q+"','"+d+"','loaded.jpg')";
                stmt.executeUpdate(sql);
            }
            catch(Exception e1){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
                ...
                String sql="insert into pizzadetail(id,Username,Pname,Size,Quantity,Prize,img)"+"values('"+(a1+1)+"','"+f+"','"+name1+"','"+na+"','"+q+"','"+d+"','periperi.jpg')";
                stmt.executeUpdate(sql);
            }
            catch(Exception e1){
                JOptionPane.showMessageDialog(null, e1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
                ...
                String sql="insert into pizzadetail(id,Username,Pname,Size,Quantity,Prize,img)"+"values('"+(a1+1)+"','"+f+"','"+name1+"','"+na+"','"+q+"','"+d+"','barbeque.jpg')";
                stmt.executeUpdate(sql);
            }
            catch(Exception e1){
                JOptionPane.showMessageDialog(null, e1);
